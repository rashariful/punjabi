                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex gap-2 mb-3">
                          {"size" in item && <Badge variant="outline">Size: {(item as any).size}</Badge>}
                          {"color" in item && <Badge variant="outline">Color: {(item as any).color}</Badge>}
                        </div>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    <Link to="/checkout">
                  <Button className="w-full mb-4 bg-orange-500 duration-300 hover:bg-orange-400">
                    Proceed to Checkout
                  </Button>
                </Link>
