...
const Login = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: "Welcome back to Punjab Palace!",
    });
  };
      ...
      >
        <Card className="border-border/50 shadow-elegant">
          <CardHeader className="text-center">
            <div className="w-16 h-16 shadow-md drop-shadow-md border-2 border-orange-300 rounded-2xl flex items-center justify-center mx-auto mb-4">
            ...
            <CardDescription>
              Sign in to your Punjab Palace account
            </CardDescription>
          </CardHeader>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <CardFooter className="flex flex-col space-y-4">
              <Button type="submit" className="w-full bg-orange-500 hover:bg-orange-400 duration-300">
                Sign In
              </Button>
